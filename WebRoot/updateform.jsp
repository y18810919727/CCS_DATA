...
<body style="background-image: url('img/bg_02.jpg');">
	...
	<form method="post" action="/CCS/doUpdateMain.servlet"
		...
		<div class="query">
			...
			<select style="height: 25px" id="isUsedID" name="isUsedName">
				<option value="1">是</option>
				<option value="2">否</option>
			</select>
			<script type="text/javascript">
				$("#isUsedID").val("<%=ingredient.isIs_used()==true?"1":"2"%>");
			</script>
		...
		<div style="margin:0 auto; width:1100px">
			<table class="table1" width="750" border="1" id="mineral">
				...
				<%
					 //ingredient = (Ingredient) request.getAttribute("ingredient");
						...
						String NO13name = ingredient.getNO13_name();
						String NO14name = ingredient.getNO14_name();
						String NO15name = ingredient.getNO15_name();
				%>
				<tr>
					<td>1</td>
				...
				<tr>
					...
					<td><input id="NO13_val" type="hidden" style="width:90px"
							   name="NO13_name" value="<%=NO13name%>" />
						<select id="NO13_name" onchange="AutoZero(13)">
							<option>LUANSHYA</option>
							<option>KANSANSHI</option>
							<option>LUMWANA</option>
							<option>CHIBULUMA</option>
			...
			<script type="text/javascript">
                ...
                changeSelected("NO13_name", $("#NO13_val").val());
                changeSelected("NO14_name", $("#NO14_val").val());
                changeSelected("NO15_name", $("#NO15_val").val());
